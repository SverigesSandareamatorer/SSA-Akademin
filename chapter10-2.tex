...
\item Byta ut ett anslutningsdon (vägguttag, lamputtag, stickpropp, skarvuttag eller liknande) för högst 16A 400V.
\item Byta ut en ljusarmatur i torrt icke brandfarligt utrymme i bostäder
\item Utföra, ändra eller reparera en starkströmsanläggning som ingår i en skyddsklenspänningskrets med nominell spänning om högst 50V med effekt om högst 200VA och ström begränsad av säkring på högst 10A.
\item Byta säkring.
...
Du får även bygga och använda en apparat avsedd att anslutas till
en starkströmsanläggning. Du är då ansvarig för att den apparat du
byggt är säker att använda och inte orsakar skada på människor eller
egendom. Kom även ihåg att 12V från ett bilbatteri räknas som en
starkströmsanläggning.

Beakta nedanstående punkter när du bygger
\begin{itemize}
...
eller egendom.
\item Är höljet till en elnätsansluten apparat av ledande material
och apparaten inte har förstärkt isolering så ska höljet anslutas
till skyddsjord.
...
för den spänning och strömstyrka de ansluts till.
...
\item Komponenter i apparaten ska placeras på lämpliga inbördes avstånd
så att risken för överslag, kortslutning eller överhettning minimeras.
\item Kablar och ledningar för starkström ska skyddas mot nötning och
skarpa kanter samt förläggas separerade från ledningar för klenspänning
och signaler.
\end{itemize}
