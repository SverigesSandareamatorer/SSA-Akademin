...
Vanliga karakteristiska impedanser i koaxialkabel är 50 och 75 Ω.
...
blir förhållandet mellan impedanserna 1:4. Se vidare i Kapitel \ref{transformatorn}.
...
$>>>>>$ TODO Bild 6-30 är ett layout-mässigt specialfall i Wibergs bok,
behöver en del arbete för att få till korrekt. Finns på sidan II6-23.
...
ändar). Den nedrersta högra figuren i bilden visar den kortslutna
\(\lambda/4\)-ledningen i tre varianter. l samtliga fall uppstår
...
\begin{figure}
  ...
  \caption{Bild II 6-31 Sätt att ansluta en matningsledning}
...
Uppbyggnad: Antennen ansluts till en \(\lambda/2\) anpassningsledning
...
förhållandet 4:1. En \(\lambda/2\) lång fasningsledning kan användas fördetta
...
resonanstillstånd (serieresonans), med maximal och likaström i båda
ledarna.
