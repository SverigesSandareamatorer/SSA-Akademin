...
Bild II 6-1 visar att i vardera änden av antennen uppnår spänningen
...
Bild II 6-3 visar ström- och spänningsfördelningen på antennen vid de
...
Bild 6-4 Elektrisk förlängning och förkorting av antenner
...
En antenns strålningsbild beskrivs bäst i tre dimensioner. Bild II 6-3
visar bl.a. ett horisontaldiagram för en halvvågsantenn.

Bild II 6-5 visar strålningen i vertikalplanet som funktion av
...
Med effekten Pi från den isotropiska antennen som referens blir
antennvinsten
...
\[G = 10 \log\frac{P_t}{P_d} \quad \text{[dBd]}\]
...
\[G = 20 \log\frac{U_t}{U_d} \quad \text{[dBd]}\]
...
Appendix C om decibelbegreppet. % TODO referens
...
\marginpar{FIXME: EIRP saknas och krävs av HAREC, lägg till.}
...
Med effekthalvvärdesbredd menas den vinkel inom vilken nyttaeffekten
...
(fältstyrkan) är minst hälften så stor som den största nyttaspänningen
\(U_f\). Spänningshalvvärdesbredden på en dipol är ungefär 90°.

Bild II 6-10 Halvvärdesbredder
