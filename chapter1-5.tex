...
för ljudvågor är \(v = c:a 340\ m/s\) vid  15\(\circ\)C och normalt lufttryck.
...
Radiovågor anses omfatta ett frekvensområde från ca 1O kHz (\(\lambda = 30\ km\)) till 300 GHz (\(\lambda = 1\ mm\)).
...
ljuset. När de båda filtren är vridna 90\(\circ\) i förhållande till varandra,
