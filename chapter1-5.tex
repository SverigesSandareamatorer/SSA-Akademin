...
Bild \ref{fig:elektromagnetiskt_spektrum}.
...
\label{fig:elektromagnetiskt_spektrum}
\end{wrapfigure}
...
\begin{wrapfigure}[25]{R}{0.5\textwidth}
  \includegraphics[width=0.5\textwidth]{images/bild_2_1-14}
...
\begin{wrapfigure}{R}{0.5\textwidth}
  \includegraphics[width=0.5\textwidth]{images/bild_2_1-15}
