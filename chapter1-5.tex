...
Eftersom naturen söker jämvikt, så breder förloppet ut sig genom mediet efter någon modell.
...
utbredningshastigheten \(v\). Våglängden är \(\lambda\) (lambda), som är avståndet mellan två
...
\begin{center}
\captionof{table}{Elektromagnetiskt spektrum}
...
vakuum är hastigheten störst, c= 299793077 m/s (= ca \(3 \cdot 10^8 m/s\)). I tät-are ämnen är
