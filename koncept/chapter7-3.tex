...
Med horisontella radialer som jordplan är matningsimpedansen cirka 35~\(\Omega\).
...
Antennen har en matningsimpedans av cirka 60~\(\Omega\) på 80- och
40-metersbanden På de högre banden är anpassningen inte optimal --
matningsimpedansen stiger där upp till cirka 100~\(\Omega\).
