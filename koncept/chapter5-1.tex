...
principscheman.4
Då kan ett blockschema vara till stor hjälp.
...
En \emph{rak sändare} är det enklaste sändarkonceptet.
...
Bilden visar en telegrafisändare där detta fenomen används för sändning
inom området 14,0--14,5 eller 3,5--4,0 beroende på passbandet i filtret
efter blandaren.
...
Bilden visar en SSB-sändare som liknar den i bild \ref{fig:bildII5-5}.
...
Sändare har många olika egenskaper som man skall vara uppmärksam på, dels för
...
Mindre avdrift i frekvens kan tolereras, men helst skall den uppfattas som
helt stabil.
...
drivegenskaper och de skall oftast vara anpassade till kabel.
...
orelaterade frekvenser skall vara undertryckta.
