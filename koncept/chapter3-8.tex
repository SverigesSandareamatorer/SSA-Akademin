...
\caption{Obalanserad blandare med resonator}
...
\caption{Dubbelbalanserad blandare}
\label{fig:BildII3-86}
\end{figure}

Bild \ref{fig:BildII3-86} visar en dubbelbalanserad blandare.

En dubbelbalanserad blandare (\emph{även kallad ringblandare}) består av fyra
...
I kapitlen 5. Mottagare och 6. Sändare beskrivs hur frekvensblandning används
