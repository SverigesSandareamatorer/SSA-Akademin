...
namnet säger för \emph{blandare} (eng. \emph{mixer}).
...
och skillnaden av ingångssignalernas frekvenser.
...
Bild \ref{fig:BildII3-84a} visar entaktsblandaren.
...
bl.a. frekvenserna \(f_1, f_2, f_2+f_1, f_2-f_1\).
...
Bild \ref{fig:BildII3-84b} visar entaktsblandaren med en resonator.
...
Bild \ref{fig:BildII3-86} visar ringblandaren.
...
deras övertoner \(2f\), \(3f\), \(4f\) och så vidare, \(2F\), \(3F\),
\(4F\) och så vidare, liksom deras blandningsprodukter \(F\pm 2f\), \(F\pm
3f\) och så vidare, \(2F \pm f\), \(2F \pm 2f\), \(2F \pm 3f\) och så vidare.
...
I ett tidigare avsnitt har vi beskrivit en s.k. super-VFO.
...
övertoner 272~MHz, 408~MHz och så vidare såväl som VFO-signalen och dess
övertoner.
På bilden är VFO-frekvensen 8~MHz och dess övertoner inritade, det vill säga 16~MHz,
24~MHz, 32~MHz och så vidare.
...
övertoner och blandningsprodukter.
