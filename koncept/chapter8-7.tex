...
skillnaden i nivå på signal och på brus, det vill säga signal minus brus, räknat i dB.
...
Fri-rymds förlusten avtar med kvadraten på avståndet, det vill säga 6~dB på dubblat
...
För att försäkra sig om att det fungerar brukar man räkna konservativt, det vill säga
man väljer de sämsta siffrorna, till exempel minsta mottagen effekt och minsta sända
effekt.
