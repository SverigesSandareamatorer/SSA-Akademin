...
\SI{14}{\mega\hertz}, men vill inte ha galvanisk isolation för det gemensamma
\SI{12}{\volt} kraftaggregatet.
...
I ett system där man har gjort parallella jordar i matningen, bild \ssaref{fig:kap4-3}, 
...
ampere av vanlig \SI{50}{\hertz} ström.
...
En vanligt förekommande spänning är \SI{48}{\volt}, som då symboliseras med P48.
...
\ssaref{comdiffv}) och gemensam och differentiell ström (kapitel \ref{comdiffi})
...
Den kapacitiva kopplingen har väldigt hög impedans vid \SI{50}{\hertz}, så man
...
Ett enkelt fall i ljudsammanhang är \SI{50}{\hertz} \SI{230}{\volt} men man vill
hålla störningen mindre än säg \SI{1}{\milli\volt}.
Det kräver mer än \SI{106}{\decibel} isolation mellan \SI{230}{\volt}
differentiellt på primärlindningen och \SI{1}{\milli\volt} gemensamt på
sekundärlindningen.
