...
Efter totalt \(5\, \text{ms}\) uppnås toppvärdet \(u_{max}\) dvs. \(+325\ \text{V}\).
Efter totalt \(10\, \text{ms}\) sker en negativ nollgenomgång.
Efter totalt \(12,5\, \text{ms}\) är spänningen \(-u\), dvs. \(-230\ \text{V}\) osv.
...
På bild \ref{fig:BildII1-16} är de högsta värdena \(+325\ \text{V}\) och \(-325\ \text{V}\).

\subsection{Topp-till-toppvärde}
\index{topp-till-toppvärde}

Topp-till-toppvärde är summan av toppvärdena över och under noll.
På bild \ref{fig:BildII1-16} är detta värde \(650\ \text{V}\).
...
grader.
Till exempel uppnås värdet noll volt vid 0\degree, 180\degree~och 360\degree~(= 0\degree).
...
% $T\,[ms] f\,[\kHz]$ eller 
% $T\,[ms] f\,[\MHz]$.
% la ur textstycket då den inte passar in och ms är felaktigt i sista raden /lorentz
%% FUUULT!!!
