...
\SI{5}{\mu F}, \quad C_2 = \SI{10}{\mu F} \) och vi söker den
...
\marginnote{HAREC a.\ref{HAREC.a.3.1.1e}\label{myHAREC.a.3.1.1e}}
\index{kondensator!seriekopplade} \index{seriekoppling!kondensatorer}

\begin{marginfigure}%[10]{R}{0.5\textwidth}
...
återverkar på varandra, det vill säga inte ''kopplar magnetiskt till
varandra'', så gäller:
...
\begin{marginfigure}%[15]{R}{0.5\textwidth}
...
Vardera induktansen ökas därför med \(M = 2\,\unit{\mu H}\).
...
varandra.
Vardera induktansen minskas därför med \(M = 2\,\unit{\mu H}\).
...
\marginnote{HAREC a.\ref{HAREC.a.1.1.4}\label{myHAREC.a.1.1.4b}}
