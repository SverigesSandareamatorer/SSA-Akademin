...
\begin{align*}
  \frac{1}{X} &= \frac{1}{X_C} - \frac{1}{X_L} \quad \text{det vill säga} \quad
...
\begin{align*}
& X_L = X_C \quad & \text{det vill säga} \quad \omega L = \frac{1}{\omega C} \\
& \text{eller} & \\
& X_L - X_C = 0 \quad & \text{det vill säga} \quad \omega L - \frac{1}{\omega C} = 0
\end{align*}
