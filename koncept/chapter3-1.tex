...
Man kan då t.ex. använda spänningen för något ändamål.
...
potentiometer med en skala graderad t.ex. i \(\Omega\).
Den andra spänningsdelaren består av en resistor med känd resistans och en
resistor med okänd resistans, d.v.s. mätobjektet.
...
Efter inkopplingen laddar strömmen upp kondensatorn, d.v.s. bygger upp ett
...
Vid frekvenserna \(f_1\) och \(f_2\) är impedansvärdet t.ex. 70~\% av
maximalvärdet.
Med bandbredden \(b\) förstås skillnaden mellan impedansvärdena i ett sådant
frekvenspar, d.v.s. \(b = f_2 - f_1\).
