...
\begin{marginfigure}%[23]{R}{0.5\textwidth}
...
\marginnote{
	...
	\noindent Ett annat namn för Q-faktor eller Q-värde är termen 
	''godhetstal'' 
	som betyder samma sak. Man kan se godhetstalet som ett mått på hur 
	underdämpat ett svängningssystem är.
}
