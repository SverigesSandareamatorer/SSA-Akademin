...
\mediumtopfig{macros/bild_tx_heat.eps}{Värmealstring i en transistor. Transistorspänning $U_{ce}$ och transistoreffekt $P_t$ varierar med vinkeln hos sinussignalen för resistiv last.}{fig:power1}
