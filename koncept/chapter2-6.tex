...
Bild \ref{fig:BildII2-16} visar schemasymboler för de vanliga transistortyperna 
NPN-transistorer (bipolära), PNP-transistorer (bipolära) och
...
\tallfig{images/cropped_pdfs/bild_2_2-17.pdf}{Skikten i en bipolär transistor}{fig:BildII2-17}
...
\mediumfig{images/cropped_pdfs/bild_2_2-18.pdf}{Emitterkopplad transistor}{fig:BildII2-18}
...
\largefig{images/cropped_pdfs/bild_2_2-19.pdf}{Karaktäristika för transistor BC 107}{fig:BildII2-19}
