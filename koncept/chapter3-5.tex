...
\marginnote{HAREC a.\ref{HAREC.a.3.5}\label{myHAREC.a.3.5}}
\label{detektorer}
\index{detektor}
\index{demodulator}
...
\marginnote{HAREC a.\ref{HAREC.a.3.5.3}\label{myHAREC.a.3.5.3}}
...
\begin{marginfigure}%[12]{5}{0.5\textwidth}
  \includegraphics[width=\textwidth]{images/cropped_pdfs/bild_2_3-60.pdf}
