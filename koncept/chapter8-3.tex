...
För att detta ska ske kan frekvensen inte vara högre än den högsta användbara
...
Den lägsta användbara frekvensen \emph{Lowest Usable Frequency (LUF)} är den
...
frekvenserna och tiderna för olika förbindelsesträckor.
Sådana förutsägelser meddelas i offentliga publikationer, men även i andra,
t.ex. tidskrifter och bulletiner inom amatörradion.

\emph{Regional Warning Center (RWC)} samlar sol- och geofysiska data och
sänder dagligen \emph{Ursigram} per telex eller brev från \emph{Union
Radio-Scientifique lnternationale (URSI)}.

Ursigram kan erhållas genom årsabonnemang (tyvärr till högt pris).
De innehåller aktuella mätvärden såsom solfläckstal \(R\), 10~cm solflux
...
Idag finns även flera webtjänster som tillhandahåller informationen gratis.
...
medlemstidning QTC.
Nya prognoser presenteras periodiskt och behandlar kortvågsspektrum.
Observera det låga solfläckstalet SSN (Sun Spot Number) på denna bild.
