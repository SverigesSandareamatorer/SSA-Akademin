...
Om detta sker växelvis uppstår förlopp såsom pendling, svängning, vågbildning
etcetera.
...
värmestrålning, vågor med ännu högre frekvens som ljus etcetera, men fortfarande är
...
överlagring även i andra vågtyper, till exempel i ljud.
