...
\SI{15}{\degreeCelsius} och normalt lufttryck.
...
300 & GHz &   1 & mm & \\\
  1 & THz & 300 & \si{\um} & Infrarött \\
  3 & THz & 100 & \si{\um} & ljus \\
 10 & THz &  30 & \si{\um} & (värme- \\
 30 & THz &  10 & \si{\um} & strålning) \\
100 & THz &   3 & \si{\um} & \\ \cline{5-5}
300 & THz &   1 & \si{\um} & Synligt ljus \\ \cline{5-5}
  1 & PHz & 300 & nm & \\
...
Radiovågor anses omfatta ett frekvensområde från ca \SI{10}{\kilo\hertz}
(\(\lambda = 30\ \text{[km]}\)) till \SI{300}{\giga\hertz} (\(\lambda = 1\ \text{[mm]}\)).

Rundradio tilldelas frekvenser i intervallet \SI{100}{\kilo\hertz} till
\SI{1000}{\mega\hertz}.
Amatörradio tilldelas ett antal frekvensområden i intervallet
\SI{136}{\kilo\hertz} till \SI{250}{\giga\hertz}.
