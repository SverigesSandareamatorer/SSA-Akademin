...
\marginnote{HAREC a.\ref{HAREC.a.2.4}\label{myHAREC.a.2.4}}
\label{transformator}
...
\marginnote{HAREC a.\ref{HAREC.a.2.4.1}, a.\ref{HAREC.a.2.4.2.1},
...
\marginnote{HAREC a.\ref{HAREC.a.2.4.2.4}\label{myHAREC.a.2.4.2.4}}
...
\marginnote{\paragraph{OBSERVERA:} Med en spartransformator kommer olika strömkretsar i galvanisk förbindelse med
...
En \emph{lågspänningstransformator} (eng. \emph{low voltage
  transformer}) med spänningen 400/230\,V används i lokala
distributionsnät, det vill säga de elektriska ledningar som går från
en transformator till vanliga hus och kontor.

För ökad säkerhet mot elektrisk chock krävs dock att vissa apparater
drivs med klenspänning via en \emph{skyddstransformator} (eng.
\emph{safety isolating transformer}).
...
\ref{fig:BildII2-11}, får inte överstiga 50\,V.


\subsection{Sambandet mellan varvtal och impedans}
\marginnote{HAREC a.\ref{HAREC.a.2.4.2.3}\label{myHAREC.a.2.4.2.3}}
