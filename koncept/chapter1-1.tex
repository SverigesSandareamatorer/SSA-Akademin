...
\num{85000000000000000000000} stycken.
...
\mediumfig{images/cropped_pdfs/bild_2_1-03.pdf}{Potential och spänning
  i en strömkrets}{fig:BildII1-3}
...
\(\textit{Arbete} = \textit{Effekt} \cdot \textit{tid}\qquad
\mathrm{[W]} = \mathrm{[P]} \cdot \mathrm{[s]}\)
