...
\(8,9\ gram\).
Den består av ca \(8,5 \cdot 10^{22}\) kopparatomer, det vill säga
...
Germanium, kisel med flera halvledare har fyra elektroner med ''fasta platser'' i
...
I den atom som elektronen lämnar bildas det i sin tur ett hål och så vidare.
...
energiförbrukare.
Källor kan vara batterier, nätaggregat etcetera.
Förbrukare kan vara lampor, ledningar etcetera.
...
annan.
Formen kan vara mekanisk, kemisk, elektrisk etcetera.
