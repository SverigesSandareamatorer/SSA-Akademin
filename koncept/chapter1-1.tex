...
sitt yttersta skal.
\emph{Maximalt ryms 8 valenselektroner.}
...
\begin{itemize}
  \item \emph{\(U\) för effektivvärdet}
  \item \emph{\(u\) för momentanvärdet (ögonblicks-)}
  \item \emph{\(\hat{u}\) för toppvärdet (amplitud-)}
\end{itemize}

\emph{Spänningen över ändpunkterna på en strömledare är \(1\ Volt\ [V]\), då
