...
behöver nå fram till repeatern, se bild \ssaref{fig:bildII7-12}.  En praktisk sak att komma ihåg med
...
FM-repeatrar.
Se IARU:s bandplaner för \SI{10}{\metre}-repeatrar i bilaga \ssaref{IARU bandplan}.
...
\noindent\begin{tabular}{l|S|S|S}
  ...
  &
  \multicolumn{1}{l|}{(\si{\mega\hertz})} &
  \multicolumn{1}{l|}{(\si{\kilo\hertz})} &
  \multicolumn{1}{l}{(\si{\kilo\hertz})}\\
      \hline
      H & 29,5 & 10 & -100\\
      F & 51   & 10 & -600\\
