...
\(a[B] = \log \dfrac{P_{hög}}{P_{låg}}\)

\(a[dB] = 10\log \dfrac{P_{hög}}{P_{låg}}\)
\hilight{TODO: NTJ ö och å i hög och låg försvinner.}
...
\(a[dB] = 10\log \dfrac{I_{hog}^2}{I_{log}^2}\)
\hilight{TODO: NTJ ö och å i hög och låg försvinner.}
...
\hilight{TODO: NTJ Nedanstående formler behöver dras isär.}
\(R_a = \infty\) \(I = 0\) \(U = E\)
