...
står för watt. Referenseffekten är då 1~W, det vill säga 0~dB(W).
...
15~dB är \(10 + 5\ dB\) det vill säga \(10 \cdot 3,2 = 32\ ggr\). Antennen matas med
\(10\ W \cdot 32 = 320\ W\).
\end{enumerate}
...
Fall 2.
När sändarutgången är kortsluten, det vill säga belastningen (antennresistansen) är
...
För att finna det optimala förhållandet mellan \(R_i\) och \(R_a\), det vill säga när
