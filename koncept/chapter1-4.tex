...
\begin{itemize}
\item {Poler med samma polaritet stöter bort va\-ra\-nd\-ra (repellerar).}
...
%
\begin{align*}
  H\ &[\textrm{A/m}] & I\ &[\textrm{A}] \\
  N\ &\text{\textrm{[varvtal]}} &  l\ &\text{\textrm{[fältlinjelängd]}}
\end{align*}
...
Den magnetiska flödestätheten \(B\) mäts i enheten tesla \([T]\) (förut gauss):

\[B = \mu \cdot H \qquad B\ \mathrm{[Vs/m^2]}, H\ \mathrm{[A/m]}\]
...
%%
\[\Phi = B \cdot A\]
\[\Phi \text{[weber eller Vs]}\qquad B \text{[T eller tesla]}, A \mathrm{[m^2]}\]
%%
