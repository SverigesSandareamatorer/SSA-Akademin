...
En hel mineralgrupp med liknande egenskaper, såsom järn, nickel med flera kallas
magnetiska.
}
...
det vill säga precis så tummen pekar om man greppar ledaren med tummen nedåt, och
...
minuspolen (-) varvid strömmen kommer gå inåt i bilden på ovansidan, det vill säga
...
\(\mu_r\).
Det anger hur många gånger bättre än luft etcetera, som materialet leder ett
magnetisk flöde.
