...
\marginnote{HAREC a.\ref{HAREC.a.1.8.2}, a.\ref{HAREC.a.1.8.6b}, a.\ref{HAREC.a.1.8.7b}\label{myHAREC.a.1.8.2}\label{myHAREC.a.1.8.6b}\label{myHAREC.a.1.8.7b}}
\index{amplitudmodulation}
\index{A3E}
...
\marginnote{HAREC a.\ref{HAREC.a.1.8.1}, a.\ref{HAREC.a.1.8.6a}, a.\ref{HAREC.a.1.8.7a}\label{myHAREC.a.1.8.1}\label{myHAREC.a.1.8.6a}\label{myHAREC.a.1.8.7a}}
\index{A1A}
\index{CW}
...
\marginnote{
	När flera stationer pratar SSB med varandra i ett \emph{ring-QSO} kan man få justera för respektive motstation eftersom sändarnas avvikelse kan vara olika från station till station.}
...
\(f + \Delta f\).
Sättet kallas FSK\marginnote{FSK---Frequency shift keying} (frekvensskiftnyckling) och används t.ex. vid sändning av olika typer av
...
Mikrovågslänkar använder till och med upp till QAM-2048. En fördel med
