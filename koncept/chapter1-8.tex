...
Man kan använda fler än två frekvenser, t.ex. används fyra frekvenser i Continuous
...
Fasskiftmodulation kan även göras med flera nivåer. Fyra olika faslägen
kan användas och kallas då för \emph{fyrnivå fasskiftmodulation} (eng.
\emph{4-state Phase Shift Keying (4-PSK)}.

Istället för 180 graders fasskift (0 och 180 grader) som 2-PSK/BPSK använder
så använder man 360/4 dvs. 90 graders fasskift mellan symbolerna.
...
att mappa bitarna över till I- och Q-amplituder  fasläge via Isym- och
...
Mikrovågslänkar använder till och med upp till 2048QAM. En fördel med
...
proportionerlig med symboltakten, det vill säga hur många baud man överför med.
...
störningar och hur dessa störningar påverkar våra överförda data. Precis som
...
Om vi i t.ex. 16QAM-koden i kapitel \ref{QAM} får in +0.2 i I och +1.1 i Q,
...
mottagaren till sändaren, t.ex. för satellitmottagare.
...
WSPR är ett sändningsslag som använder amatörradiostationen som en radiofyr, en s.k.
...
De flesta av dessa sändningsslag (se nedan) är smalbandiga, som ibland inte upptar
...
FreeDV skiljer sig mot de sändningsslag som nämnts ovan, genom att denna är tänkt
