...
Alltså \(f_{HF} + f_{LF}\) (övre sidfrekvens) och skillnadsfrekvensen
\(f_{HF} - f_{LF}\) (undre sidfrekvens).
...
8 bitar, så motsvarar det 16 kb respektie 10 Mb. I dagligt tal pratar vi då om
storleken på en fil.
...
proportionelig med symbol-takten, dvs. hur många Baud man överför i.
...
begräsning, så kommer mottagningen av digitala signaler att bli störd.
Vi skall titta på dessa grundläggande begrepp som bitfel, bitfelssannolikhet,
felupptäkt samt korrigering med återsändning eller korrigeringskoder.
...
kombinaton och sedan jämförs det med paritetsbiten, och om de överensstämmer så
...
tagit emot har fel, är att begrära omsändning. Genom att sändaren håller en
