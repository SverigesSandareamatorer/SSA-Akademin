...
likhetstecknet, kan t.ex. ''flyttas'' över till andra sidan om likhetstecknet,
...
5^{-2} & \text{ i stället för } \frac{1}{25} \text{ och så vidare}
\end{align*}
...
Det vill säga \[\frac{a^m}{a^n} = a^{m-n}\]

Är \(n\) större än \(m\) får exponenten negativt tecken t.ex. för \(m = 5\) och
\(n = 7\)
...
I övriga fall är det nödvändigt att skriva ut rottermen, t.ex.
...
Dessa räkneoperationer kan göras t.ex. med en miniräknare.
