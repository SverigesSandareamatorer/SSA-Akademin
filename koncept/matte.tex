...
blir resultatet annorlunda när man skriver \(\dfrac{3}{15}\) i stället för
\(\dfrac{15}{5}\).
...
något av sätten \(15:3\) eller \(15/3\) eller \(\frac{15}{3}\).
...
\(\dfrac{x}{3}\). och femtedelen är \(\dfrac{x}{5}\).
...
Kom ihåg: \(5x-2x\) är samma som \(5x-x-x\) eller \(5x-(x+x)\), d.v.s. \(3x\).
