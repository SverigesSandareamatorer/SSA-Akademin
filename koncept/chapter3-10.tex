...
värde, det vill säga låta varje enskilt sampel i tur och ordning multipliceras med
...
Utöver själva filterstrukturen, det vill säga IIR och FIR, så karakteriseras de av hur
...
det vill säga förmågan att omvandla från signalstyrka över tid till signalstyrka över
frekvens.
Eftersom processingen sker i diskret tid, det vill säga värden med en viss tid emellan,
...
snabb DFT, det vill säga \emph{Fast Fourier Transform (FFT)}, som även den är diskret.
...
Högsta frekvensen blir \emph{Nykvist-frekvensen}, det vill säga halva
