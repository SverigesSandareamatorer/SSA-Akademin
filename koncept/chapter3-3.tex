...
\subsection{Halv- och helvågslikriktning med mera}
...
\item Med två dioder och mittuttag på transformatorns sekundärlindning.
  ...
  Den andra dioden och andra lindningshalvan under följande halvperiod och så vidare.
...
\item Med fyra dioder (s.k. Graetz-brygga) och inget mittuttag på
  ...
  Dioderna 2 och 4 släpper igenom ström under följande halvperiod och så vidare.
...
Stabiliseringen tillgår så att till exempel zenerdioden får ingå som aktiv del i en
