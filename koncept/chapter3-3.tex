...
\marginnote{HAREC a.\ref{HAREC.a.3.3}\label{myHAREC.a.3.3}}
\label{kraftaggregat}
...
\marginnote{Äldre stationära radioutrustningar drivs nästan alltid med nätanslutna
...
\marginnote{HAREC a.\ref{HAREC.a.3.1.1g}\label{myHAREC.a.3.1.1g}, a.\ref{HAREC.a.3.3.1}\label{myHAREC.a.3.3.1}}
\index{likriktning}
\index{rectifier}
...
\marginnote{HAREC a.\ref{HAREC.a.3.3.2}\label{myHAREC.a.3.3.2}}
\index{glättning}
...
\begin{marginfigure}
  \includegraphics[width=\textwidth]{images/cropped_pdfs/bild_2_3-38.pdf}
...
\marginnote{HAREC a.\ref{HAREC.a.3.3.4}\label{myHAREC.a.3.3.4}}
