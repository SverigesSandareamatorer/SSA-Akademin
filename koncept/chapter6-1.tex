...
\mediumfig{images/cropped_pdfs/bild_2_5-02.pdf}{Flerstegs rak sändare}{fig:bildII5-2}
...
\mediumfig{images/cropped_pdfs/bild_2_5-03.pdf}{FM-sändare med frekvensmultiplicering}{fig:bildII5-3}
...
\SI{435}{\mega\hertz} (\SI{70}{\centi\metre}-bandet).
...
Sändningsfrekvensen blir då \(8,056 \cdot 54 = \SI{435}{\mega\hertz}\).
...
\mediumfig{images/cropped_pdfs/bild_2_5-04.pdf}{2-bands CW-sändare med frekvensblandning}{fig:bildII5-4}
...
Bild \ref{fig:bildII5-4} visar en telegrafisändare där detta fenomen används för
...
\harec{a}{5.3.1}{5.3.1}
\harec{a}{5.3.4}{5.3.4}
\harec{a}{5.3.10}{5.3.10}
\harec{a}{5.3.12}{5.3.12}
\index{telefoni}
\index{SSB}
\index{sändare!SSB}

%% k7per: Fix the figure to have the correct sign for the second row.
\mediumfig{images/cropped_pdfs/bild_2_5-05.pdf}{2-bands SSB-sändare med frekvensblandning}{fig:bildII5-5}
...
\mediumfig{images/cropped_pdfs/bild_2_5-06.pdf}{Flerbands SSB-sändare med frekvensblandning}{fig:bildII5-6}
...
\mediumfig{images/cropped_pdfs/bild_2_5-07.pdf}{PLL-styrd FM-sändare för FM}{fig:bildII5-7}
...
Vid en VCO-frekvens av \SI{144}{\mega\hertz} (\SI{144000}{\kilo\hertz}) motsvaras
divisorn 57600 (= \(10 \cdot 5760\)) av en pulsfrekvens av \SI{2,5}{\kilo\hertz}
ut från räknarkedjan.
På samma sätt kommer en VCO-frekvens av \SI{144025}{\kilo\hertz} och divisorn
57610 (= \(10 \cdot 5761\)) också att ge en pulsfrekvens av
\SI{2,5}{\kilo\hertz}, likaså \SI{146}{\mega\hertz} och divisorn 58400 och så
vidare.

VCO-frekvensen låses alltså i intervall om \SI{25}{\kilo\hertz} till närmaste
delningstal, för att uppnå en pulsfrekvens av \SI{2,5}{\kilo\hertz}.
...
referensfrekvens som efter en delning med 10 också är \SI{2,5}{\kilo\hertz}.
...
\mediumfig{images/cropped_pdfs/bild_2_5-08.pdf}{PLL-styrd SSB-sändare för kortvåg}{fig:bildII5-8}

Bild \ref{fig:bildII5-8} visar ett avancerat koncept för en kortvågssändare.
SSB-signalen alstras på frekvensen \SI{9}{\mega\hertz} och blandas med
\SI{61}{\mega\hertz} i 1:a blandaren.

Summafrekvensen \SI{70}{\mega\hertz} filtreras fram som mellanfrekvens.
Den önskade sändningsfrekvensen fås genom att blanda \SI{70}{\mega\hertz} MF med
...
så stor som \SI{28,5}{\mega\hertz} eller 1:20.
Frekvensändringen i VCO är \SI{29,5}{\mega\hertz}, men där är
...
\textbf{Exempel:} Vid en MF på \SI{9}{\mega\hertz} behöver VCO-funktionen täcka
...
genom blandning av de två CO-frekvenserna 9 och \SI{61}{\mega\hertz}.
Den framfiltrerade bärvågen med frekvensen \SI{70}{\mega\hertz} blandas med
...
och ändra frekvensen \SI{9}{\mega\hertz} med ett värde så att filtret blir
verksamt i det motsatta sidbandet eller genom att behålla frekvensen
\SI{9}{\mega\hertz} och byta till ett SSB-filter som är verksamt i det motsatta
sidbandet.
...
ofta \SI{10}{\mega\hertz}.

%% k7per: Remove hard layout.
%% \newpage % layout
