...
\marginnote{ \vspace{\baselineskip}\\\emph{Fördjupning:} Om man räknar fram vad
	grundbruset är i det elektromagnetiska spektrat baserat på formeln ovan vid
	rumstemperatur (ca 300\,K) så får man fram ett värde per 
	Hz som kan vara intressant att lägga på minnet nämligen 
	-174\,dBm/Hz.
  ...
  översätta till dB. 
  Detta görs genom \( B_{\unit{dB}}=10 \cdot \log(B) \). För en bandbredd på 3 
  kHz innebär det \SI{34,8}{dB} över $N_0$.
