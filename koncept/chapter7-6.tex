...
Vanliga karaktäristiska impedanser för bandkabel är 75 och 300~\(\Omega\).
...
En sådan ledning måste således strömkopplas, dvs. den anslutande
impedansen måste vara låg.

Den kortslutna \(\lambda/4\)-ledningen har en spänningsbuk i ingångsänden.
En sådan ledning måste spänningskopplas, dvs. den anslutande impedansen måste
vara hög.
