...
påverkan från jordplan och omgivning med mera
...
\(3\lambda/2\), \(2\lambda\), och så vidare över mark.

När en horisontell antenn däremot placeras \(\lambda/4\), \(3\lambda/4\),
\(5\lambda/4\) och så vidare över mark, är utstrålningen övervägande vertikal, vilket
