...
När antennen, mätt i våglängder, befinner sig mycket högt över jordytan, d.v.s.
...
en 4~dubblad sändareffekt \(\mathrm{[W/m^2]}\).

Ungefärlig antennvinst för olika antenner med en isotrop antenn som referens:
...
\(F/B = 0\) dB betyder att \(U_f = U_b\), d.v.s. att fältstyrkorna i
