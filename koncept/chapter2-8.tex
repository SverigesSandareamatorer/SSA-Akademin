...
\includegraphics[]{images/cropped_pdfs/bild_2_2-41.pdf}
...
\begin{marginfigure}%{R}{.5\textwidth}
	\includegraphics[]{images/cropped_pdfs/bild_2_2-42.pdf}
...
\begin{figure}%{R}{.5\textwidth}
	\centering
	\includegraphics[width=.5\textwidth]{images/cropped_pdfs/bild_2_2-43.pdf}
...
\begin{figure}
\includegraphics[width=.7\textwidth]{images/cropped_pdfs/bild_2_2-44.pdf}
\caption{DTL-logik}
\label{fig:BildII2-44}
\end{figure}

\begin{figure}
	\includegraphics[width=.7\textwidth]{images/cropped_pdfs/bild_2_2-45.pdf}
	\caption{TTL-logik}
