...
\smallfig[0.25]{images/cropped_pdfs/bild_2_2-42.pdf}{Exklusiv
  ELLER-grind (EXOR-gate)}{fig:BildII2-42}

\subsubsection{Exklusiv INTE ELLER-grind (XNOR-gate)}
\index{XNOR-gate}

\smallfig[0.25]{images/cropped_pdfs/bild_2_2-43.pdf}{Exklusiv INTE
  ELLER-grind (EXNOR-gate)}{fig:BildII2-43}
