\section{Filter}
\marginpar{HAREC a.\ref{HAREC.a.3.2}\label{myHAREC.a.3.2}, 
a.\ref{HAREC.a.3.2.9}\label{myHAREC.a.3.2.9}}
\index{filter}
...
Bild \ref{fig:BildII3-22} visar ett \emph{högpassfilter} (eng. \emph{highpass 
filter (HP)}) släpper igenom signaler med höga frekvenser och dämpar dem med 
låga frekvenser.
...
\[   f_g\ \text{[Hz]} \qquad L\ \text{[H]} \qquad C\ \text{[F]}   \]

\textbf{RC-Högpass:}
\[  f_g = \frac{1}{2\pi RC} \]
\[  f_g\ \text{[Hz]} \quad R\ [\Omega] \quad C\ \text{[F]}\]

\noindent\textbf{Räkneexempel 1.}

\[   L = 4\ \text{H} \qquad C = 1\ \mu\text{F} \qquad f_g =\ ?   \]

\[
	f_g = \frac{1}{2\pi \sqrt{4 \cdot 10^{-6}}} 
	    = \frac{500}{2\pi }
        = 79,6\,\unit{Hz}
\]

\noindent\textbf{Räkneexempel 2.}

\[   R = 1\ k\Omega \qquad C = 10\ \text{nF} \qquad f_g =\ ?   \]

  \[
    f_g = \frac{1}{2\pi  \cdot 1 \cdot 10^3 \cdot 10 \cdot 10^{-9}}
    = \frac{10^5}{2\pi } = 15,9\,\unit{kHz}
  \]
...
\begin{marginfigure}
\includegraphics[width=\textwidth]{images/cropped_pdfs/bild_2_3-28.pdf}
...
\marginpar{HAREC a.\ref{HAREC.a.3.2.11}\label{myHAREC.a.3.2.11}}
...
\begin{marginfigure}
\includegraphics[width=\textwidth]{images/cropped_pdfs/bild_2_3-29.pdf}
...
%%\begin{center}
\begin{marginfigure}
  \includegraphics[width=.5\textwidth]{images/cropped_pdfs/bild_2_3-31.pdf}
...
\begin{marginfigure}
	\includegraphics[width=.7\textwidth]{images/cropped_pdfs/bild_2_3-32.pdf}
	\caption{Pi-filter}
	\label{fig:BildII3-32}
\end{marginfigure}

\subsection{Pi-filter}
\marginpar{HAREC a.\ref{HAREC.a.3.2.10a}\label{myHAREC.a.3.2.10a}}
\index{Pi-filter}
...
\begin{marginfigure}
	\includegraphics[width=.7\textwidth]{images/cropped_pdfs/bild_2_3-33.pdf}
	\caption{T-filter}
	\label{fig:BildII3-33}
\end{marginfigure}

\subsection{T-filter}
\marginpar{HAREC a.\ref{HAREC.a.3.2.10b}\label{myHAREC.a.3.2.10b}}
\index{T-filter}
...
\marginpar{HAREC a.\ref{HAREC.a.3.2.12}\label{myHAREC.a.3.2.12}}
...
komponenter, till exempel kommer en LC krets i praktiken alltid vara en LCR
krets, där förlusterna i spole och kondensator ger en ekvivalent förlust i
...
\marginpar{HAREC a.\ref{HAREC.a.3.2.13}\label{myHAREC.a.3.2.13}}
\index{digitala filter}

Med den utveckling som skett, kan allt mer processing ske digitalt, det gör det
möjligt att göra \emph{digitala filter}, om bara signalen konveterats till
