...
induktionsslingor, kondensatorer eller direkt galvaniskt. \emph{Kavitetsfilter}
(eng \emph{cavity filter}) kan kopplas ihop för att bilda bandfilter,
frekvensdelare m.m.
...
För alla analoga komponenter så är de verkliga egenskaperna behäftade med
...
plattorna med en parasitisk parallellkopplad resistans, som kommer att ladda ur
kondensatorn.
...
ideal omvärld. Vare resonator lastas dock, vilket ytterligare ökar på förlusten
...
det möjligt att göra digitala filter, om bara signalen konverterats till
