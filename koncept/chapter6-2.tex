...
För en lyckad duplex-operation krävs i allmänhet mer än \SI{100}{\decibel}
...
cirka \SI{800}{\hertz} vid mottagning.
...
En kristallfrekvens av cirka \SI{12}{\mega\hertz} multipliceras 12 gånger i en
...
För ett sving av \SI{3}{\kilo\hertz} på bärvågen är svinget på oscillatorn bara
\SI{250}{\hertz}.
...
Lokaloscillatorkedjans utfrekvens läggs \SI{10,7}{\mega\hertz} över eller under
...
Den relativt höga 1:a mellanfrekvensen \SI{10,7}{\mega\hertz} ger ett så stort
...
Eftersom mottagarens mellanfrekvens MF är \SI{10,7}{\mega\hertz} måste nämligen
VCO ligga \SI{10,7}{\mega\hertz} högre eller lägre vid mottagning än vid
sändning.
...
För till exempel \SI{21}{\mega\hertz}-bandet är VFO-filtrets passband
\SIrange{12}{12,5}{\mega\hertz}.
När en VFO-signal \SIrange{12}{12,5}{\mega\hertz} blandas med en
\SI{9}{\mega\hertz} SSB modulerad signal erhålls en frekvens i området
...
som enkelsuper.
Eftersom en MF på \SI{9}{\mega\hertz} används även i mottagaren kommer
...
kristallfiltret i signalbehandlingskretsarna för \SI{9}{\mega\hertz}.
...
\largefig{images/cropped_pdfs/bild_2_5-14.pdf}{SSB-transceiver för kortvåg}{fig:bildII5-14}

\mediumfig{images/cropped_pdfs/bild_2_5-15.pdf}{PLL-styrd SSB-transceiver för kortvåg}{fig:bildII5-15}
...
dubbelsuper.
SSB-signalen bereds på \SI{9}{\mega\hertz}-nivån och flyttas därefter upp till
\SI{70}{\mega\hertz}-nivån genom frekvensblandning och filtrering.
De möjliga sändningsfrekvenserna mellan 0,5 och \SI{30}{\mega\hertz} skapas
...
\SI{61}{\mega\hertz} i fasregleringskretsen och inte heller SSB-modulatorn,
