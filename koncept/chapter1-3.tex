...
\begin{quote}
\(1\ C = 1\ A \cdot 1\ s = 1\ \mathrm{amperesekund}\ [1\ As]\)

\(1\ \mathrm{coulomb} = 1\ \mathrm{ampere} \cdot 1\ \mathrm{sekund}\)
\end{quote}
...
\[
\begin{array}{cc}
E=\dfrac{\Delta U}{\Delta l} & \dfrac{[\mathrm{volt}]}{[\mathrm{meter}]}
\end{array}
\]
