...
\marginnote{HAREC a.\ref{HAREC.a.1.3}\label{myHAREC.a.1.3}}
...
Måttenheten för elektrisk laddning är coulomb som betecknas med[C].

Laddningsmängden 1 coulomb motsvarar 6,25 triljoner (\num{6,25d18})
elementarladdningar. Sambandet mellan laddning och ström är
\begin{equation*}
	Q = I \cdot t
\end{equation*}

Laddning [Q] är ström [I] över tiden [t].
...
\marginnote{HAREC a.\ref{HAREC.a.1.3.1}, a.\ref{HAREC.a.1.3.2}\label{myHAREC.a.1.3.1}\label{myHAREC.a.1.3.2}}
\index{elektrisk fältstyrka}
\index{symbol!\(E\) elektrisk fältstyrka}

\begin{marginfigure}
  \includegraphics[width=\textwidth]{images/cropped_pdfs/bild_2_1-06.pdf}
  \caption{Elektrisk fältstyrka}
  \label{fig:BildII1-6}
%  \vspace{-30pt}
\end{marginfigure}

\marginnote{\vspace{1em}\\I bild \ref{fig:BildII1-6}, \(U = f(l)\) visas spänningarna utmed
...
\begin{equation}
E=\dfrac{\Delta U}{\Delta l} \quad \dfrac{[\unit{volt}]}{[\unit{meter}]}
\end{equation}

\subsection{Skärmning av elektriska fält}
\marginnote{HAREC a.\ref{HAREC.a.1.3.3}\label{myHAREC.a.1.3.3}}
