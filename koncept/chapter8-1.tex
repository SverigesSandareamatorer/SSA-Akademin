...
polaritet. När den matas med en växelström, så rör sig laddningarna
...
Som nämnts består en radiovåg av ett högfrekvent elektromagnetiskt fält
...
samma fält är horisontellt sägs vågen vara horisontellt polariserad.
