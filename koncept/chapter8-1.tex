...
tjockleken.
Ledaren (antennen) kan kallas dipol -- den har två poler.
Se bild \ref{fig:BildII7-01}.
...
Då innehåller den mest lägesenergi och ingen rörelseenergi.
När pendeln rör sig mot mittläget, så omvandlas lägesenergin till rörelseenergi.
I mittläget, som är det andra ytterlighetstillståndet, innehåller pendeln mest
rörelseenergi och ingen lägesenergi etc.

\subsubsection{Elektrisk svängningskrets}
\index{kraftfält!elektrisk svängningskrets}
\index{elektrisk svängningskrets}
\index{Maxwell}
...
vända, så innehåller kondensatorn mest laddning, d.v.s. det starkaste
elektriska fältet mellan elektroderna.
Detta fält är lägesenergi.
...
avskiljs från den. De visade kraftlinjerna är E- fältet.
