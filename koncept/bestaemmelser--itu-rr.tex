...
ska vara tillåten, om inte administrationen i en av de berörda
nationerna har meddelat att den är emot sådan radiokommunikation.
\cite[25.1]{ITU-RR}

25.2 \S2 1) Sändning mellan amatörstationer i olika länder ska vara
begränsad till spontan kommunikation med syftet att nyttja amatörtjänsten,
som definierad i 1.56, och av personlig karaktär.
\cite[25.2]{ITU-RR}

25.2A \S2 1A) Sändning mellan amatörstationer i olika länder ska
...
att använda en amatörstation ska bevisa sin förmåga att sända och ta
emot text i morsesignaler.
\cite[25.5]{ITU-RR}

25.6 \S3 2) Administrationerna ska kontrollera de handhavandemässiga och
...
25.7 \S4 Den högsta effekten från en amatörstation ska fastställas
av berörda administrationer.
\cite[25.7]{ITU-RR}

25.8 \S5 1) Alla allmänna regler i överenskommelsen och de i denna
artikel ska tillämpas på amatörradiostationer.
\cite[25.8]{ITU-RR}

25.9 \S5 2) Under loppet av sändningarna ska amatörstationer sända
...
25.10 \S6 Bestämmelserna i Sektion 1 i denna artikel ska gälla i all
...
ska kunna avbrytas omedelbart av den bemyndigande administrationen.
...
\emph{allotment} och \emph{assignment} används ska de ha den
betydelse som ges i 1.16 till 1.18, varvid termerna på de tre
arbetsspråken ska vara som följer (franska, engelska och spanska):
\cite[5.1]{ITU-RR}
