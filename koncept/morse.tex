...
\begin{wrapfigure}{R}{0.5\textwidth}
  \fbox{\includegraphics[width=0.5\textwidth]{images/bild_morse_1.png}}
...
\begin{figure}
  \fbox{
    \includegraphics[width=0.5\textwidth]{images/bild_morse_3.png}
    \includegraphics[width=0.5\textwidth]{images/bild_morse_4.png}
  }
...
\begin{wrapfigure}{R}{0.5\textwidth}
  \fbox{\includegraphics[width=0.5\textwidth]{images/bild_morse_5.png}}
...
\begin{figure}
  \fbox{\includegraphics[width=\textwidth]{images/bild_morse_6.png}}
...
\begin{figure}
  \fbox{\includegraphics[width=\textwidth]{images/bild_morse_7.png}}
  \caption{Handstilar}
  \label{fig:bild_morse_7}
\end{figure}

\begin{figure}
  \fbox{\includegraphics[width=\textwidth]{images/bild_morse_8.png}}
  \caption{Handstilar}
