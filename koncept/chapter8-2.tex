...
Flera mätfunktioner kan utföras med samma basinstrument.
Med en omkopplare väljer man mätfunktion och mätområde.
Instrumentskalan utformas så att olika slags mätvärden kan avläsas.
Kombinationer med elektroniska förstärkare och digital visning etc. är nu vanligt.
...
olinjäritet hos halvledardioderna i instrumentet.
...
En spektrumanalysator visar amplituden för olika frekvenser över ett visst
frekvensområde.
...
För en specifik mätning ställer man in start- och stoppfrekvens, eller
alternativt en centerfrekvens och en bandbredd för mätområdet.
...
En spektrumanalysator består förenklat av en variabel oscillator,
...
Detektorn, som det kan finnas flera av, kan vara topp- eller RMS-detektor, .
...
Vid kalibrering använder man ofta kalibreringsreferenserna last (eng. load),
kortslutning (eng. short) samt öppen port (eng. open).
