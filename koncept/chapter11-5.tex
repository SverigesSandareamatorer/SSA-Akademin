...
som sänder \cite[\S19.1]{ITU-RR}. Detta görs genom att man sänder en
...
Alla sändningar med falsk eller missledande identifiering är förbjuden \cite[\S19.2]{ITU-RR}!
...
Amatörradiosignaler är uppbyggda på följande sätt \cite[\S19.68, \S19.69]{ITU-RR}:
