...
Flera mätfunktioner kan utföras med samma basinstrument, som vissas i
...
Vid mätning och inställning av t.ex. modulation och uteffekt, är det lämpligt
...
Den kan bestå av en eller flera sammankopplade resistorer, ofta parallelt för
...
T.ex. är oljor med PCB förbjudna!
...
Instrumentet visar endast relativa värden och används t.ex. för att bestämma
...
gradering av nya skalor o.s.v. för densamma.
...
Den består av en brusgenerator och en Wheatstone-brygga för mätning av
...
Mäter man vid flera frekvenser, kan t.ex. ett impedansdiagram upprättas.
...
SVF-metern kan vara ständigt inkopplad t.ex. mellan sändare och antenn, men
...
När varje mätning börjar så kommmer en räknare räkna hur många triggerpulser
...
mellan räknarens värde och frekvensen, genom att ha tides om 100~ms, 1~s, 10~s
osv.
Dessa räknare har dock problemet att för låga frekvenser så krävs lång
observationstid för att försäkra sig om en tillräckligt bra numerisk precission.
En variant av detta som framkom var den så kallade reciproka räknaren, som är
den nu förhärskande principen när man behöver precission, i den så mäts både
...
Med tidsupplösning på 1~ps-nivå kan därför 12~siffrors noggranhet presenteras
för en mätning över 1~sekund, medans för gamla frekvensräknare med sin 10~MHz
oscillator gav 100~ns upplösning och därmed enbart 7~siffrors noggranhet för
...
eller för dyrare instrument en rubidiumnormal.
...
SI-definitionen av Hertz till en nu mer modest kostnad även i ett hobby-labb.
...
\emph{Dip-metern} är i princip en oscillator med variabel frekvens och
...
Resonansfrekvensen i dip-meterns svängningskrets är steglöst variabel och
frekvensvärdet kan avläsas på en skala.

Vid mätning av resonansfrekvensen i en passiv svängningskrets kopplas
dip-meterns induktor induktivt till kretsen så som visas i bild
\ref{fig:bildII8-13}.
När resonansfrekvensen i kretsen och dip-metern överensstämmer, ändras
belastningen i dip-meterns svängningskrets varvid instrumentet uppvisar en
strömminskning -- en ''dip''.
Frekvensen avläses då på skalskivan.

Vid mätning på en aktiv svängningskrets, d.v.s. som drivs av någon HF-källa,
...
Namnet grid-dipmeter kommer från elektronrörsepoken.
...
tidbasgenerator som alstrar en sågtandformad signal ansluts till X-förstärkaren.
...
amplituder mm. men dessvärre blir mätprecisionen ofta kraftigt lidande, och
...
Det vi fortsättningsvis beskriver i detta kapitel, är sålunda den svepande
...
Detta brus avtar, ju längre bort man kommer från den instälda signalen.
