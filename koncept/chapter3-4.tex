...
Distorsion uppstår även vid överstyrning, d.v.s. när insignalens amplitud är
...
d.v.s. som förvrängda signaler långt vid sidan om den egentliga nyttosignalen.
...
Viloströmmen är noll, d.v.s. arbetspunkten ligger på den negativa delen av
styrkaraktäristikan.
...
förstärkare i klass C.  (På följande tre bilder är \(I_R\)=anodviloström).
...
lågpassfilter.
Övertoner för 144~MHz är 288~MHz, 432~MHz o.s.v.
...
uteffekten.
I gallerjordad koppling är kapacitansen låg mellan katod och anod, d.v.s.
