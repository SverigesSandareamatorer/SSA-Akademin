\section{Förstärkare}
\marginnote{HAREC a.\ref{HAREC.a.3.4}\label{myHAREC.a.3.4}}
\index{förstärkare}
\index{amplifier}
\index{blandning}
\index{mixing}
...
Transistorn presenteras i avsnitt \ref{transistorn} och elektronröret i avsnitt
\ref{elektronrör}.
...
\marginnote{HAREC a.\ref{HAREC.a.3.4.1}, a.\ref{HAREC.a.3.4.2},
  a.\ref{HAREC.a.3.4.3}
  \label{myHAREC.a.3.4.1}
  \label{myHAREC.a.3.4.2}
  \label{myHAREC.a.3.4.3}}
...
\marginnote{HAREC a.\ref{HAREC.a.2.6.4.1}, a.\ref{HAREC.a.2.6.4.2}, a.\ref{HAREC.a.2.6.4.3}, a.\ref{HAREC.a.2.6.4.4}\label{myHAREC.a.2.6.4.1}\label{myHAREC.a.2.6.4.2}\label{myHAREC.a.2.6.4.3}\label{myHAREC.a.2.6.4.4}}
...
\emph{Kollektorkoppling} används när hög ingångsimpedans och utgångsimpedans
önskas. Denna koppling har emellertid ingenspänningsförstärkning, men kan
användas för så kallad impedansomvandling.

\begin{table*}[!h]
\caption{Grundkopplingarnas typiska egenskaper vid NPN-transistor}
  \begin{tabular}{llll}
    \bf Egenskap & \bf Emitterkoppl. & \bf Baskoppl. & \bf Kollektorkoppl. \\ \hline\hline
    \(Z_{in}\) & medel  1\,k\(\Omega\) & liten  50\,\(\Omega\) & stor 100\,k\(\Omega\) \\
    \(Z_{ut}\) & medel  10\,k\(\Omega\) & stor  100\,k\(\Omega\) & liten 50\,k\(\Omega\) \\ \hline
    Förstärkning & & & \\
     \quad Ström- & stor  100\,ggr & $<$1 0,9\,ggr & stor  100\,ggr \\
     \quad Spänning- & stor  100\,ggr & stor  100\,ggr & $<$1  0,99\,ggr \\
     \quad Effekt- & m. stor \num{10000}\,ggr & stor  100\,ggr & stor  100\,ggr \\ \hline
    Fasläge & motfas 180\degree & medfas  0\degree & medfas 0\degree \\
  \end{tabular}
\end{table*}
...
\marginnote{HAREC a.\ref{HAREC.a.3.4.4}\label{myHAREC.a.3.4.4}}
...
\begin{marginfigure}
  \includegraphics[width=\textwidth]{images/cropped_pdfs/bild_2_3-44.pdf}
...
\begin{marginfigure}
  \includegraphics[width=\textwidth]{images/cropped_pdfs/bild_2_3-45.pdf}
  \caption{Förstärkare i klass B}
  \label{fig:BildII3-45}
\end{marginfigure}

\begin{marginfigure}
  \includegraphics[width=\textwidth]{images/cropped_pdfs/bild_2_3-46.pdf}
...
svängningskrets, som är avstämd till önskad frekvens, det vill säga överton
av insignalen.
...
Således:
\begin{align*}
  3,5 \cdot 2 & = 7\,\unit{MHz} \\
  3,5 \cdot 2 \cdot 2 & = 14\,\unit{MHz} \\
  3,5 \cdot 2 \cdot 3 & = 21\,\unit{MHz} \\
  3,5 \cdot 2 \cdot 2 \cdot 2 & = 28\,\unit{MHz} \\
\end{align*}
...
\marginnote{HAREC a.\ref{HAREC.a.2.8.2}\label{myHAREC.a.2.8.2}}
\index{slutsteg}
...
\begin{marginfigure}%{R}{0.5\textwidth}
  \includegraphics[width=\textwidth]{images/cropped_pdfs/bild_2_3-48.pdf}
  \caption{Slutsteg med en transistor}
  \label{fig:BildII3-48}
\end{marginfigure}

Drossel \(Dr\) och kondensator \(C\) fungerar som en HF-mässig avkoppling av
strömförsörjningen.
...
\marginnote{HAREC a.\ref{HAREC.a.1.9.6}\label{myHAREC.a.1.9.6}}
...
\[
  \mathrm{PEP} =
  \left(\dfrac{\hat{u}}{\sqrt{2}}\right)^2\cdot\frac{1}{R}
  = \frac{\hat{u}^2}{2R}
\]
...
\begin{marginfigure}%{R}{0.5\textwidth}
  \includegraphics[width=\textwidth]{images/cropped_pdfs/bild_2_3-52.pdf}
...
Toppvärdet (amplituden):
\[
\hat{u}= \dfrac{\hat{u}_{\text{t-t}}}{2}
\]

Effektivvärdet:
\[
U = \dfrac{\hat{u}}{\sqrt{2}}
\]
...
\[
P_{\text{PEP}} = \dfrac{U^2}{R} \quad \text{respektive} \quad
P_{\text{PEP}} = \dfrac{\hat{u}_{t-t}^2}{8R}
\]
...
\marginnote{HAREC a.\ref{HAREC.a.3.4.5}\label{myHAREC.a.3.4.5}}
...
Ett slutsteg med jordat galler fordrar en större driveffekt, varvid risken för
