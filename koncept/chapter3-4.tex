...
\emph{mixing}) av signaler, för multiplicering av signalfrekvenser etcetera
...
De används t.ex. i mottagarnas ingångs- och mellanfrekvenssteg, liksom i
...
Det kan man göra t.ex. med en separat spänningskälla eller vanligare med en
...
Distorsion uppstår även vid överstyrning, det vill säga när insignalens amplitud är
...
LF- och HF-förstärkarsteg, t.ex. i mottagare samt AM- och SSB-modulerade
sändare.
...
det vill säga som förvrängda signaler långt vid sidan om den egentliga nyttosignalen.
...
Viloströmmen är noll, det vill säga arbetspunkten ligger på den negativa delen av
styrkaraktäristikan.
...
T.ex. finns det frekvenstripplingssteg byggda kring en speciell typ av
kapacitansdiod -- varaktordiod.
Vanliga frekvensområden för s.k. varaktortripplare är 144/432~MHz och
432/1296~MHz.
...
P.g.a. de låga impedansvärdena i transistoriserade förstärkarsteg används
...
Orsakerna kan vara många, bl.a. dålig avkoppling av matningsspänningar, induktiv
och/eller kapacitiv återkoppling i kretsarna med mera.
...
uteffekten.
I gallerjordad koppling är kapacitansen låg mellan katod och anod, det vill säga
...
ökade kapacitanser i kopplingsledningarna med mera, vilket är till nackdel vid höga
rekvenser.

Ett enda slutrör för hela effekten är emellertid dyrare än flera små
med tillsammans jämförbar effekt.
Mottaktkoppling av två rör (eng. ''push-pull'') i st.f. parallellkoppling har
en fördel i högre förstärkning, men nackdelar i mer komplicerad bandomkoppling
av svängningskretsar med mera.
...
okänsligare i övriga avseenden.
...
P.g.a. behovet av flera olika spänningar är även strömförsörjningen för ett
slutsteg med elektronrör mer komplicerad och omfångsrik.
...
Genom förvrängning p.g.a. olinjär förstärkning uppstår ömsesidiga summa- och
skillnadsfrekvenser av de modulerande frekvenserna.
...
Detta kan bl.a. avhjälpas med inställning av mikrofonförstärkaren och riktig
mikrofonhantering.
