...
\[C\ [\textit{farad}]\quad A\ [m^2]\qquad d\ [m]\quad \varepsilon\ [\dfrac{F}{m}]\]
...
laddningsmängden. Men i en väx\-el\-st\-röm\-s\-kr\-ets växlar spänningen och polariteten 
...
Detta visar att en kondensator inte hindrar elektronflödet i en vä\-xel\-st\-rö\-m\-s\-krets.
...
\[X_C\ [\Omega]\quad (f\ [Hz]\quad (C\ [F]\]
%%
\emph{Exempel:}
%%
\[C = 10\ \mu F\quad f = 50\ Hz\quad X_c = ?\]
\[X_c = \dfrac{1}{2\pi fC} = \dfrac{1}{2\pi 50 \cdot 10 \cdot 10^{-6}} = 318,3\ \Omega\]
%%
\emph{Exempel:}
%%
\[C = 10\ \mu F\quad f = 5\ kHz\quad X_c = ?\]
