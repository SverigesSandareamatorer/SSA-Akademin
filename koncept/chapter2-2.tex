...
\(X_c = \dfrac{1}{2\pi fC}\) eller \(X_c = \frac{1}{\omega C}\)
...
\(X_c = \frac{1}{2\pi fC} = \frac{1}{2\pi 50 \cdot 10 \cdot 10^{-6}} = 318,3\ \Omega\)

2. \(C = 10\ \mu F\) \(f = 5\ kHz\) \(X_c = ?\)

\(X_c = \frac{1}{2\pi fC} = \frac{1}{2\pi 5 \cdot 10^3 \cdot 10 \cdot 10^{-6}}
= 3,183\ \Omega\)
...
samtidigt som spänningen. I en ideal kondensator är spänningen fasförskjuten 90\degree
efter strömmen.

\subsection{Förlustvinkel}
\index{förlustvinkel}

I praktiken är fasförskjutningen i en kondensator något mindre än 90\degree på grund
