...
\begin{itemize}
\item Telegrafi är tillåtet över hela bandet, men är exklusivt i området
50,000--50,100~MHz.

\item Under 50,500~MHz används inte FM.

\item 50,110~MHz är interkontinental DX anropsfrekvens och bör inte användas för
trafik inom Europa.

\item För kanaltrafik är kanaldelningen 20~kHz, förskjutet 10~kHz.
\end{itemize}
