...
\begin{table}[b]
  \begin{center}
    \begin{tabular}{ll|lll}
      ...
      Q   & \MQvintus & = & \MAtskillnad & Åtskillnad \\
      R   & \MRudolf  & \textasciitilde & \MLystring & Lystring \\
      S   & \MSigurd  & $\sqrt{}$  & \MVanta & Vänta \\
      T   & \MTore    & $f$  & \MForstatt & \\
      U   & \MUrban   &   & \MFelskrivning & Felsändning \\
      V   & \MViktor  & + & \MSluttecken & Slut eller plus \\
      W   & \MWilhelm & @ & \MAvslutning & Avslutning \\
...
\largefig[.5]{images/cropped_pdfs/bild_morse_8.pdf}{Handstilar}{fig:bild_morse_8}
\twocolumn
