...
Ett enkelt fall i ljud-sammanhang är 50~Hz 230~V men man vill hålla störningen
mindre än säg 1~mV. Det kräver mer än 106~dB isolation mellan 230~V
diffrentiellt på primärlindningen och 1~mV gemensamt på sekundärlindningen.
Så god balans kan vara svår att finna i enskilda komponenter. Principen
återkommer oavsett spänning och frekvens, det är en inperfektion man behöver
lära sig att förstå och hantera.

\subsection{Obalans i antennsystem}
\index{obalans!antennsystem}

Obalans kan även förekomma i antenn-system, där en obalanserad antenn omvandlar
...
den diffrentiella strömmen, som ju motverkar utstrålning plötsligt får en
...
Detta görs med en ström-balun, lämpligtvis en kvartsvåg ned från anslutningen
till antennen. Ström-balunen motverkar ju den gemensamma strömmen utan att
...
skärm/jord som överför energi. När vi ansluter denna ledare till en dipol-
antenn vill vi se till att strömmen går balanserat ut i de bägge ledarna,
så att mitt-punkten är nära noll, så att det inte går en ström med gemensam
mod ut i matarledningen. Vi har alltså dels behovet att omvandla obalancerad
signal till balancerad samt undertrycka gemensam signal i ledaren, och därtill
...
kan vara av en obalancerad typ, t.ex. Off-Center-Feed (OCF)/Windom, eller
för att den kopplar olika med miljön som träd och torn mm.
