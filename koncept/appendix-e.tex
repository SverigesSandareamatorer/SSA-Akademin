...
Den nödvändiga bandbredden (eng. \emph{necessary bandwidth})
beskrivs med tre siffror och en bokstav. Bokstaven placeras på
platsen för decimaltecknet och representerar enheten för
bandbredd. Bokstäverna H (Hz), K (kHz), M (MHz) och G (GHz)
används, medan varken 0 eller K, M eller G får vara det första
tecknet. Numeriska värden med mer än tre signifikanta siffror
avrundas.
...
\item[\textnormal{100H A1A AN}] Morsetelegrafi genom nyckling av bärvåg, 125-takt, bandbredd 100~Hz, s.k. CW.
...
\item[\textnormal{2K12 F3C MN}] Faksimil med halvtoner (telefoto), kooperationsindex 264, avsökningshastighet 90~linjer/minut, frekvensmodulering med \(\pm\) 400~Hz skift.
