...
Vid snabba strömändringar, till exempel vid hög frekvens, är motverkan större än vid
långsamma ändringar.
...
sluts och motsatt riktning när den bryts, det vill säga det blir en växelspänning.
...
pendlingen en frekvens av 50~Hz och så vidare.
...
induktorns induktansvärde. Inga förluster uppstår i en ideal induktor, det vill säga en
...
man till exempel kompensera en positiv temperaturkoefficient i induktorn med en negativ
i en kondensator.
