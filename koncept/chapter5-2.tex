...
Bilden visar en enkel transceiver för telegrafi.
...
I det koncept på en kortvågstransceiver, som visas här, ingår en super-VFO i
signalberedningen.
...
Bilden visar en SSB-transceiver där passbandfilter i förkretsar,
MF-filter och kristalloscillatorer har dubbel användning.
...
s.k. ''all-mode''-utförande, erbjuder många funktionella möjligheter.
...
uppgifter t.ex. om sändningsslag och andra inställningar.
