...
sker oftast med en koaxialkabel med 50~\(\Omega\) karakteristisk
impedans. Eftersom matningsimpedansen för själva riktantenn nästan
aldrig är 50~\(\Omega\), så behövs oftast en impedansanpassning mellan antenn
och kabel.
...
Matningsimpedansen är 50--70~\(\Omega\), beroende på elementavståndet.
