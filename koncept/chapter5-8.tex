...
För repeatrar så används det för att även nyckla sändaren, så därför måste man
...
SSAs repeateransvarig har tilldelat CTCSS subtoner för de olika regionerna,
