...
<\ssahref{http://www.ssa.se/}{\texttt{www.ssa.se}}>.
En annan populär variant är QRZ
<\ssahref{https://www.qrz.com/}{\texttt{www.qrz.com}}> där man kan registrera sig.
Anropssignalen används även för online-loggning av kontakter, så som Logbook of
the World (LoTW) <\ssahref{https://lotw.arrl.org/}{\texttt{lotw.arrl.org}}>.
