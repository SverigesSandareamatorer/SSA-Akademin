...
Sverige är tilldelat prefix i serierna SA--SM, 7S och 8S \cite[Appendix 42]{ITU-RR-appendices}.
...
Det förekommer att man hör en station ropa \emph{''CQ DX''}.
Det är en station som i allmänhet söker kontakt utanför sin egen kontinent.
Detta brukar vara givet av den angivna signalen.

-- ''CQ DX, CQ DX, CQ DX, SM0XYZ Calling CQ DX and standing by''

I detta fallet är det SM0XYZ som söker att nå någon utanför Europa.
Är du själv inte inte DX, dvs. på samma kontinent så skall du undvika att ropa.

En station som ropar CQ kan få många som vill få kontakt, när många som försöker
få stationens uppmärksamhet samtidigt bildas en sammelsurium av röster som
kallas för \emph{pile-up}.

När stationen betar av en pile-up kan stationen äver fråga \emph{''QRZ?''}
dvs. vem där?
En station kan alternera mellan fullt CQ och QRZ? eftersom den som lyssnar på
en pile-up kommer fort bli uppmärksam på signalen och vad som händer.

Ibland gör man så kallade \emph{DX expeditioner} då man begett sig till en
plats som sällan aktiveras.
Vi aktivering blir dessa \emph{rar DX} (eng. \emph{rare DX}), då en ovanlig
signal eller ovanligt landområde aktiverats som många vill ha i sin logg.

En rar DX kan drabbas av att få enorma pile-ups, och det kan bli svårt för
många att höra DX-stationen beroende på alla de som försöker ropa in på den.
En strategi att få detta att fungera effektivare är att köra split
\cite{LowBandDX}, dvs. att DX-stationen lyssnar på en högre frekvens än den
sänder på.
Effekten av det är att själva pile-up av anropande stationer inte stör
sändningen från DX-stationen.
Detta gör att den som DX-stationen för tillfället pratar med kan höra
DX-stationen även om andra dånar in.
Detta gör kommunikationen effektivare, för den begränsas enbart av DX-stationens
förmåga att höra pile-upen, men inte motstationens förmånga att höra
DX-stationen mot närliggande störningar.

Den ropande DX-stationen brukar annonsera sin splitt med ''listening 10 up'',
vilket skall tolkas som att DX-stationen lyssnar 10~kHz ovanför sin sändnings-
frekvens.
Skall du försöka ropa upp DX-stationen skall alltså din TX-frekvens då vara
10~kHz över din RX-frekvens.
Det är ofta enkelt att ställa in split-frekvens på stationer.
Det är en konvention att split-frekvensen skall vara 5, 10 eller 20~kHz, men
det är rekommendabelt att den är 10~kHz eller mer.

\textbf{Försök under inga omständigheter rätta en station som kör split!}
...
ta utrymme, använd tålamod och vänta ut bra tillfälle.
Ropa inte under den tid som stationerna har ett CQ, det gör bara att de blir
störda och det tar längre tid.
Operatören som kör CQ kan även bli irriterad på dig och andra, och utesluta er
ur de anropsignaler/calls som kommer besvaras, så respektera alltid operatören
för effektivast utnyttjad tid till bägges nytta.
Det kan vara nyttigt att lyssna in sig på operatörens stil.
Respektera att operatören kan höra helt andra stationer starkare än vad du hör,
...
och därför fråga ''only stations on 0 please'' eller
''only european station please''.
Detta är ett försök av operatörern att dela upp en stor pile-up till lite
mindre massiv så att operatören skall ha en chans att fånga calls.
När det delas upp på nummer så kommer operatören ta några med ett visst nummer,
sen gå vidare till nästa osv, tills 0 till 9 är genomgångna.
Alternativet att gå på regioner eller landsprefix kan vara bättre, och
särskilt om operatören upplever att konditionerna dit snart försvinner och
därför vill ge dem en extra förtur innan de helt tappar chansen.

\textbf{Respektera alltid DX-operatörens uppdelning och ropa inte när det inte
  är din tur!}
