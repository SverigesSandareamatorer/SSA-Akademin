...
förstärkaren.
För de högre frekvenserna kommer merparten av strömmen att gå genom kondensatorn och motkopplingen blir därför högre än för låga frekvenser.
...
negativa ingångens sida kopplar man loss från jord och ansluter till insignalen.
...
\(R_1\) och utgången kommer mata \(R_2\) mot jord. Förstärkningen kommer vara
