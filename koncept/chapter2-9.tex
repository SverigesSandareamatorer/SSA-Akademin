...
%%     (opamp.+) to (-2, 0.5)
%%     (-2, 0.5) node[label={[font=\footnotesize]below:in}] {}
%%     (2.1, 0)  node[label={[font=\footnotesize]ut}] {}
%%     (opamp.out) to (2, 0)
%%     ;
%%   \end{circuitikz}
%% }{Icke-inverterande förstärkare}{fig:BildII2-46}

\smallfig{images/cropped_pdfs/bild_2_2-46.pdf}{Icke-inverterande förstärkare}{fig:BildII2-46.x}
...
\smallfig{images/cropped_pdfs/bild_2_2-47.pdf}{Inverterande förstärkare}{fig:BildII2-47}
