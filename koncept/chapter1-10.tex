...
effektivt. En processor kan i stället utföra de mindre frekventa jobben som därmed 
kan tillåtas vara mer komplexa.
...
Har man t.ex. ett kvantiseringssteg på 0,1~V så blir 0 till 0,1~V tolkat som
