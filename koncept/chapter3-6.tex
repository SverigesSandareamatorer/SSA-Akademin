...
\includegraphics[width=0.5\textwidth]{images/cropped_pdfs/bild_2_3-64.pdf}
...
\begin{wrapfigure}{R}{0.5\textwidth}
\includegraphics[width=0.5\textwidth]{images/cropped_pdfs/bild_2_3-65.pdf}
...
insignalen. Fasvridningen \(\alpha=180\degree\) betecknas här med
