...
som ingångsspänningen \(\hat{U}_{in}\) och är i rätt fasläge, d.v.s. i
detta exempel
...
skala, d.v.s.  över vridkondensatorns hela kapacitansområde, varvid
...
Resultatet blir en frekvensskala med större upplösning, d.v.s. bättre
