...
\noindent\textbf{Exempel}: En krets med strömkälla, lampa, kopplingsledningar och
smältsäkring.
...
Resistansen mellan två punkter i en strömkrets är \SI{1}{\ohm} som även skrives
\SI{1}{\ohm} (uttalas ''en åm''), när spänningen \SI{1}{V} mellan punkterna gör att
