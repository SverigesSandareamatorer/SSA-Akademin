...
För att bestämma resistansen, till exempel i en tråd,
...
skineffekt, det vill säga strömkoncentration vid ytan, som medför viss resistansökning.
...
gemensamt isolerande underlag, det vill säga liknande teknik som för tjock- och
tunnfilmsresistorer.
...
hög temperatur; det kan vara keramik, glas etcetera.
...
resistans vid hög spänning. VDR används till exempel för begränsning av
spänningstoppar.
...
metallegeringar, som till exempel i konstantan, kan resistansen till och med vara
...
vid en axel i banans centrum, medger enkel inställning med mejsel, ratt etcetera.
...
Bättre än en kolbana är en bana av kolkomposit, det vill säga kolpulver med bindemedel,
...
logaritmisk etcetera. Olinjära kurvor består då oftast av en följd av linjära
