...
XO-frekvens.
Blandningsprodukten \(f_1 - f_2\) filtreras fram, det vill säga en signal i området
...
utfrekvens med vilket som helst av talen 5760, 5761, 5762 och så vidare upp till 5840.
...
Detta underlättar utformning och placering av reglage etcetera för
...
transformatorkärna etcetera kan försämra oscillatorns frekvensstabilitet.

Frekvensbestämmande komponenter såsom fasta och variabla kondensatorer, spolar
etcetera ska vara stabilt monterade, trimkärnorna i spolarna fixerade och så vidare
