...
\begin{wrapfigure}{R}{0.5\textwidth}
  \includegraphics[width=0.5\textwidth]{images/bild_2_3-75.png}
...
\begin{wrapfigure}{R}{0.5\textwidth}
\includegraphics[width=0.5\textwidth]{images/bild_2_3-76.png}
...
\begin{figure}
\includegraphics[width=\textwidth]{images/bild_2_3-77.png}
...
\begin{wrapfigure}[43]{R}{0.5\textwidth}
  \includegraphics[width=0.5\textwidth]{images/bild_2_3-78.png}
  \caption{VFO och VCO jämförs}
  \label{fig:BildII3-78}

  \includegraphics[width=0.5\textwidth]{images/bild_2_3-79.png}
  \caption{Kapacitansdiod -- Varicap}
  \label{fig:BildII3-79}

  \includegraphics[width=0.5\textwidth]{images/bild_2_3-80a.png}
...
\begin{figure}
  \includegraphics[width=\textwidth]{images/bild_2_3-80b.png}
...
\begin{figure}
\includegraphics[width=\textwidth]{images/bild_2_3-81.png}
...
\begin{figure}
\includegraphics[width=\textwidth]{images/bild_2_3-82.png}
...
står i förhållande till den spänning som läggs över transistorn. 
