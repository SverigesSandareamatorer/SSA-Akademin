...
\emph{spänningstyrd oscillator} (eng. \emph{Voltage Controlied Oscillator
  (VCO)}).
I resonanskretsen i en VCO fyller en kapacitansdiod (varicap, variable
...
likspänning.
Då skulle bland annat resonanskretsens godhetstal försämras (förlorad HF-energi
innebär dämpning).
...
Resonanskretsar ska skärmas från yttre kapacitanstillskott
(t.ex. från en hand).
...
Eftersom kapacitansen i transistorn är en del av resonanskretsen, så påverkar
...
På grund av det större godhetstalet i resonanskretsen, och därmed den mindre
