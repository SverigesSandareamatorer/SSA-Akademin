...
\begin{figure}
  ...
  \caption{Bild II 5-3 FM-sändare med frekvensmultiplicering}
  \label{fig:bildII5-3}
\end{figure}
...
\begin{figure}
  ...
  \caption{Bild II 5-6 Flerbands SSB-sändare med frekvensblandning}
  \label{fig:bildII5-6}
\end{figure}
...
\begin{figure}
  ...
  \caption{Bild II 5-8 PLL-styrd SSB-sändare för kortvåg}
  \label{fig:bildII5-8}
\end{figure}
