...
För att översiktligt beskriva en komplicerad sändare eller transeeiver
...
Bilden visar ett blockschema för en FMsändare för 435 MHz (70
...
oscillatorfrekvensens deviation. En deviation av max3000Hz från den
...
sändare, eftersom ino ch utgångsfrekvenserna i flera av stegen är
olika.

De frekvensmultiplicerande stegen i bild II 5-3 arbetar i klass C,
...
Bild II 5-4 2-bands CW-sändare med frekvensblandning
...
sändaren i Bild 5-4.  Filtermetoden är den mest använda för att bereda
...
Bilden visar en SSB-sändare som liknar den i Bild II 5-5. Den stora
...
första fallet (Bild II 5-2) kan frekvensen i den enda ocillatorn
styras av en PLL. I det andra fallet (Bild II 5-6) kan frekvensen i
...
progammeras in i steg om 1 mellan talen 5760 och 5840.
...
VCO-frekvensen tilllikhet med börvärdet. Regleringsförloppets
...
additiv blandning (se sidan II 3-63) via en kondensator. De
% TODO sidreferens
variationer i reglerspänningen som kommer av talet är snabbare än
laopfiltrets tidskonstant Variationerna av talet hinner därför inte
...
Bild II 5-8 PLL-styrd SSB-sändare för kortvåg
...
denna signal och att därför HFfrekvenserna i det resterande sidbandet
...
(sidan II 4-11). % TODO sidreferens
