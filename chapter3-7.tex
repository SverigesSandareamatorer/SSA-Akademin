...
komponenternas egenskaper. När mycket bättre stabiltet än så krävs,
...
I en kristalloscillator (CO, Crystal Oscillator) är en kvartskristall
...
Bild II 3-75 Colpittsoscillator med kristall i parallellresonansfallet

Bild II 3-76 Colpittsoscillator med kristall i serieresonansfallet
...
koppling, som är en kombination av LC-VFO och CO, kallad super-VFO.

I en super-VFO blandas en låg, variabel frekvens från en VFO med en
hög frekvens från en CO. Ordet super kommer från superheterodyne =
överlagring, blandning.  En VFO arbetar stabilare på låg frekvens
medan en CO fortfarande arbetar stabilt även på högre frekvenser, dock
inte så högt som vi behöver här. I vårt exempel arbetar därför VFO i
området 8-10 MHz och CO på 17 MHz. VFO-signalen blandas med en fast
signalfrekvens, som är CO-signalen 17 MHz multiplicerat med 8,
d.v.s. 136 MHz.
...
bättre än hos en enkel VFO, som arbetardirekt i VHF-området. En
...
En kristalloscillator (CO) arbetar med god frekvensstabilitet
...
I en PLL (Phase Locked Loop) kan god frekvenstabilitet och stort
frekvensområde förenas. En PLL är en sluten krets för elektrisk
styrning av en oscillator, så att dess frekvens är både stabil och
variabel.
...
En VFO, vars frekvens kan styras med en likspänning, kallas VCO
(Voltage Controlied Oscillator). I svängningskretsen i en VCO fyller
en kapacitansdiod (varicap, variable capacitor) samma uppgift som den
mekaniskt variabla kondensatorn i en VFO.
...
signalen från en VCO (är-värdet) och signalen från en CO (bör-värdet).

Bild II 3-79 Kapacitansdiod- Varicap

Bild II 3-80a Analogi Människa-PLL
...
pulserande utgångsspänningen frånjämföraren. Om VCO-frekvensen är för
...
När signalen från VCO åter är lik referenssignalen från CO, till
...
kondensator urladdas med den hastighet som bestäms av tidskonstante
n. Den sjunkande styrspänningen medför att kapacitansdiodens
spärrskikt blir tunnare, kapacitansen tilltar och VCO-frekvensen
sjunker tills en ny fas- och frekvenslikhet uppnåtts.

Bild II 3-80b Oscillator med PLL-styrning
...
144146 MHz. Denna blandas med signalen \(f_2\) (136 MHz), som är en
multiplicerad CO-frekvens. Blandningsprodukten \(f_1 - f_2\) filtreras
...
med CO och programmerbar frekvensdelare.
...
referensfrekvensen från en CO. I princip fås en VCO med samma
frekvensstabilitet som en CO, men också lika svår att ändra frekvensen
på. Med en frekvensdelare i fasregleringsslingan (PLL) kan emellertid
utfrekvensen ändras, medan CO fortfarande avger samma
...
delningstalet och resultatet jämförs med referensfrekvensen från CO.
Varje avvikelse från likhet med referensfrekvensen kommer att
medförajustering av VCO-frekvensen.
...
Bild II 3-81 PLL-oscillator kombinerad med frekvensblandning
...
och speciellt jämfört med en CO. VCO-svängningskretsen har nämligen
ett relativt lågt godhetstal eftersom en kapacitansdiod belastar
kretsen mer än en mekanisktvariabel kondensator.
...
Bild II 3-82 PLL med frekvensdelare
...
så att signalen blir så ren som möjligt från oönskade sidafrekvenser.
...
A-drift, bild II 3-44) för att inte alstra övertoner och därmed
förvränga oscillatorsignalen. Bild II 3-42 visar ett buffertsteg i
...
Oscillatorn bör monteras så långt bort som möjligtfrån övriga
...
brusundertryckningen och desto merframhävs den önskade
...
ändras inom ettstörre område. Önskas flera valbara frekvenser från en
